...
def extract_mutli_masks(mask_path, output_dir=None, class_value=255, min_area=10):
    """
...
if __name__ == "__main__":
    ...
    # 提取所有建筑物掩码
    masks = extract_mutli_masks(label_path, output_dir=None)
